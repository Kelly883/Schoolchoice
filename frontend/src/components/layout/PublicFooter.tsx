...
const footerLinks = {
  ...
  Admissions: [
    ...
    { name: 'Book a Tour', href: '/school-tour' },
  ],
  Resources: [
    { name: 'News', href: '/news' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="font-display font-bold text-xl text-white">SchoolName</span>
                <span className="block text-xs text-neutral-400 -mt-1">Excellence in Education</span>
              </div>
            </Link>
            <p className="text-sm text-neutral-400 mb-4">
              Providing quality education and building future leaders since 1990.
            </p>
